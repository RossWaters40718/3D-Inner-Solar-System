...
def about():
       ...
       msg8='\nProgramming Language: Python 3.12 64-Bit'
...
def anim_start(frames, speed):# Start Animation
    ...
    anim=animation.FuncAnimation(fig=Anim_Fig ,init_func=init, func=anim_advance, repeat=False, frames=frames, blit=True, interval=speed, cache_frame_data='False')
...
if __name__ == "__main__":
    ...
    Anim_Fig=plt.figure(figsize=(root_hgt*px,root_wid*px),facecolor='#000000',dpi=100)
